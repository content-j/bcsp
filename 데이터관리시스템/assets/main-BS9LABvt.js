...
function initFilterExtendComponent() {
  const containers = document.querySelector(".page-content-aside");
  if (containers) {
    const btnExtend = containers.querySelector(".btn-filter-extend");
    const btnOpen = containers.querySelector(".btn-filter-open");
    btnExtend.addEventListener("click", () => {
      containers.classList.add("is-extend");
    });
    btnOpen.addEventListener("click", () => {
      containers.classList.remove("is-extend");
    });
  }
}
document.addEventListener("DOMContentLoaded", () => {
  initFilterExtendComponent();
